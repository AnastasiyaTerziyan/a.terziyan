package ru.kpfu.itis.group11408.terziyan.matrixmultiplication;
...
public class MatrixMultiplication {
	   static int[][] a;
	    ...
	    public MatrixMultiplication(int size1, int size2, int size3) {
	    ...
	    public static void main(String[] args) {
	        ...
	        MatrixMultiplication matrixMult = new MatrixMultiplication(sc.nextInt(), sc.nextInt(), sc.nextInt());
